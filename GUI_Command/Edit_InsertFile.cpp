#include "Edit_InsertFile.h"

GtkWidget *Edit_InsertFile::filechooserdialog1=NULL;
GtkWidget *Edit_InsertFile::dialog_vbox1=NULL;
GtkWidget *Edit_InsertFile::dialog_action_area1=NULL;
GtkWidget *Edit_InsertFile::button1=NULL;
GtkWidget *Edit_InsertFile::button2=NULL;

Edit_InsertFile::Edit_InsertFile()
{
...
void Edit_InsertFile::single(GtkWidget *widget,GdkEvent *event,gpointer data)
{
	setupGUI();
	gtk_widget_show_all(filechooserdialog1);
}

void Edit_InsertFile::setupGUI()
{
...
void Edit_InsertFile::okbutton_OnClicked(GtkWidget *w,GtkFileSelection *fs)
{
	const gchar *filename=gtk_file_chooser_get_filename (GTK_FILE_CHOOSER (filechooserdialog1));
	inputCommand("insertfile",(char *)filename);
	inputCommand(".","");
	gtk_widget_hide_all(filechooserdialog1);
}

void Edit_InsertFile::cancelbutton_OnClicked(GtkWidget *widget,GdkEvent *event,gpointer data)
{
	gtk_widget_hide_all(filechooserdialog1);
}


void Edit_InsertFile::inputCommand(char *cmd,char *arg)
{
